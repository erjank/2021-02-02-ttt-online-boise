...
humandate: "February 2-5"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9 am to 12:30 pm (MST)"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2021-2-2      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2021-2-5        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Eric Jankowski", "Zhian Kamvar"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["ericjankowski@boisestate.edu","zkamvar@carpentries.org"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
etherpad: https://docs.google.com/document/d/15-zeiWFIVAQ0i6xtU-wvAz1CM0DCFeFlJl8TideQYjk/edit?usp=sharing            # optional: URL for the workshop Etherpad if there is one
...
This is an online event. We will meet using the online videoconference software Zoom. You will need to <a href="https://zoom.us/download">download and install their client</a> to connect with your instructors. The link to use for this event is <a href="{{ loc.address }}">{{ loc.address }}</a>.
